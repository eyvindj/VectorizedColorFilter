...
#' @examples
#' \dontrun{
#' testimage <- "~/path/to/your/image/test.jpg"
#' testimage2 <- "~/path/to/your/image/test2.jpg"
...
testimage <- "~/Rprogrammingversioncontrol/VectorizedColorFilter/inst/extdata/test.jpg"
testimage2 <- "~/Rprogrammingversioncontrol/VectorizedColorFilter/inst/extdata/test2.jpg"
